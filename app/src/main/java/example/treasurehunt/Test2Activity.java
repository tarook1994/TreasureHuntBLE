...
public class Test2Activity extends AppCompatActivity implements BeaconManager.RangingListener {
                ...
                for (DataSnapshot friendSnapshot : dataSnapshot.getChildren()) {
                    ...
                    for(int i =0 ;i<friendSnapshot.getChildrenCount()/2;i++){
                        ...
                        if(counter%2!=0){
                            ...
                            databaseArray2.add(friendSnapshot.child("Clue").getValue()+"");
                        }
                        counter++;
                    }
    ...
    public ArrayList<String> filterBeacons(List<Beacon> beacons){
        ...
        for(int i =0;i<beacons.size();i++){
            if(beacons.get(i).getMacAddress().toStandardString().equals("20:91:48:4C:5B:E6") ||
                ...
                Toast.makeText(getApplicationContext(),"la2eet " +beacons.get(i).getMacAddress().toStandardString(),Toast.LENGTH_SHORT).show();
                Log.d("E6",beacons.get(i).getMacAddress().toStandardString());
            }
        }
